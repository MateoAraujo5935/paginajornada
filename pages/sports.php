...
$sportData = [
    ...
    'football_female' => [
        ...
        'format_desc_co' => 'notReady',
        'fixture_co' => 'https://challonge.com/es/vcxei3yc/module'
    ],
    ...
    'volleyball' => [
        ...
        'format_desc_cb' => 'notReady',
        'fixture_cb' => 'https://challonge.com/es/q57cwf9t/module',
        'teamsCO' => [
        ...
        'format_desc_co' => 'notReady',
        'fixture_co' => 'https://challonge.com/es/6zkqbnts/module'
    ],
    ...
    'handball' => [
        ...
        'format_desc_cb' => 'notReady',
        'fixture_cb' => 'https://challonge.com/es/8go9sdps/module',
        'teamsCO' => [
        ...
        'format_desc_co' => 'notReady',
        'fixture_co' => 'https://challonge.com/es/ig68so0s/module'
    ],
    ...
    'fifa' => [
        'title' => 'FIFA',
        'teamsCB' => [
            ['name' => 'Los Pollitos FC', 'class' => '1A', 'flag' => './imagenes/flags/1a.webp'],
            ['name' => 'La Banda FC', 'class' => '1A', 'flag' => './imagenes/flags/1a.webp'],
            ['name' => 'Los Galácticos FC', 'class' => '1A', 'flag' => './imagenes/flags/1a.webp'],
            ['name' => 'Sanguchitos FC', 'class' => '1A', 'flag' => './imagenes/flags/1a.webp'],
            ['name' => 'Nafta Con Speed', 'class' => '1A', 'flag' => './imagenes/flags/1a.webp'],
            ['name' => 'Los De La Noche', 'class' => '1B', 'flag' => './imagenes/flags/1b.webp'],
            ['name' => 'Maripositas Alocaditas', 'class' => '1B', 'flag' => './imagenes/flags/1b.webp'],
            ['name' => 'Los Baltas', 'class' => '1B', 'flag' => './imagenes/flags/1b.webp'],
            ['name' => 'Puercos FC', 'class' => '1B', 'flag' => './imagenes/flags/1b.webp'],
            ['name' => '1/11/14', 'class' => '1C', 'flag' => './imagenes/flags/1c.webp'],
            ['name' => 'Manchester Pritty', 'class' => '1C', 'flag' => './imagenes/flags/1c.webp'],
            ['name' => 'Belplate', 'class' => '1C', 'flag' => './imagenes/flags/1c.webp'],
            ['name' => 'Rústicos FC', 'class' => '1C', 'flag' => './imagenes/flags/1c.webp'],
            ['name' => 'La Virzineta', 'class' => '2A', 'flag' => './imagenes/flags/2a.webp'],
            ['name' => 'La Dupla Galáctica', 'class' => '2A', 'flag' => './imagenes/flags/2a.webp'],
            ['name' => 'AC Frío', 'class' => '2A', 'flag' => './imagenes/flags/2a.webp'],
            ['name' => 'Panchoneta', 'class' => '2B', 'flag' => './imagenes/flags/2b.webp'],
            ['name' => 'Barcecola', 'class' => '2B', 'flag' => './imagenes/flags/2b.webp'],
            ['name' => 'Cloaca FC', 'class' => '2B', 'flag' => './imagenes/flags/2b.webp'],
            ['name' => 'Nottingham Miedo', 'class' => '2B', 'flag' => './imagenes/flags/2b.webp'],
            ['name' => 'Atlético Pururú', 'class' => '2C', 'flag' => './imagenes/flags/2c.webp'],
            ['name' => 'La Morcineta', 'class' => '2C', 'flag' => './imagenes/flags/2c.webp'],
            ['name' => 'Los Matadores', 'class' => '3A', 'flag' => './imagenes/flags/3a.webp'],
            ['name' => 'Los Piratas', 'class' => '3A', 'flag' => './imagenes/flags/3a.webp'],
            ['name' => 'Camisetas Nani', 'class' => '3B', 'flag' => './imagenes/flags/3b.webp'],
            ['name' => 'La Chancletilla', 'class' => '3B', 'flag' => './imagenes/flags/3b.webp'],
            ['name' => 'Pesuti', 'class' => '3B', 'flag' => './imagenes/flags/3b.webp'],
            ['name' => 'La Banda Del Babolineo', 'class' => '3B', 'flag' => './imagenes/flags/3b.webp'],
            ['name' => 'La Mafia A Colocar', 'class' => '3B', 'flag' => './imagenes/flags/3b.webp'],
            ['name' => 'La Chispa', 'class' => '3B', 'flag' => './imagenes/flags/3b.webp'],
            ['name' => 'Tengo Fé', 'class' => '3C', 'flag' => './imagenes/flags/3c.webp'],
            ['name' => 'Cokismo FC', 'class' => '3C', 'flag' => './imagenes/flags/3c.webp']
            
        ],
        'format_desc_cb' => 'notReady',
        'fixture_cb' => 'https://challonge.com/es/gn9mk8b0/module',
        'teamsCO' => [
            ['name' => 'Sacachispas', 'class' => '6B', 'flag' => './imagenes/flags/6.webp'],
            ['name' => 'Pisala Pomelo', 'class' => '4A', 'flag' => './imagenes/flags/4a.webp'],
            ['name' => 'Pase Al Medio', 'class' => '6A', 'flag' => './imagenes/flags/6.webp'],
            ['name' => 'Los Discipulos De Gastón', 'class' => '5A', 'flag' => './imagenes/flags/5a.webp'],
            ['name' => 'Muletas FC', 'class' => '5A', 'flag' => './imagenes/flags/5a.webp'],
            ['name' => 'GAGAstón', 'class' => '6B', 'flag' => './imagenes/flags/6.webp'],
            ['name' => 'TikiTaka', 'class' => '6A', 'flag' => './imagenes/flags/6.webp'],
            ['name' => 'Convivencias FC', 'class' => '5A', 'flag' => './imagenes/flags/5a.webp'],
            ['name' => 'Mostoles Dux', 'class' => '5B', 'flag' => './imagenes/flags/5b.webp'],
            ['name' => 'Gastón Pittaro Y Sus Redonditos De Ricota', 'class' => '5A', 'flag' => './imagenes/flags/5a.webp'],
            ['name' => 'Mari FC', 'class' => '4C', 'flag' => './imagenes/flags/4c.webp'],
            ['name' => 'La Banda De La Luján', 'class' => '6C', 'flag' => './imagenes/flags/6.webp'],
            ['name' => 'La Mafia De Pastoral', 'class' => '5A', 'flag' => './imagenes/flags/5a.webp'],
            ['name' => 'Sirux FC', 'class' => '4B', 'flag' => './imagenes/flags/4b.webp'],
            ['name' => 'La Gastoneta', 'class' => '5A', 'flag' => './imagenes/flags/5a.webp'],
            ['name' => 'Max Win', 'class' => '6C', 'flag' => './imagenes/flags/6.webp']
        ],
        'format_desc_co' => 'notReady',
        'fixture_co' => 'https://challonge.com/es/obxc9r9/module'
    ],
];
